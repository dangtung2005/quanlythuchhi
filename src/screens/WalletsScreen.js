...
export default function WalletsScreen({ data, theme, onEditWallet, onAddWallet }) {
  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={appStyles.scrollContent}>
      <View style={styles.headerRow}>
        ...
        <TouchableOpacity activeOpacity={0.85} style={styles.addButton} onPress={onAddWallet}>
